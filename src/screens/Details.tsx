    ...
    <ScrollViewContainer isReady={details.isReady} refreshFunction={getData}>
      <SafeAreaView>
        ...
        {details.genres.length > 0 && (
          <StyledContentsContainer>
            <StyledContentsTitle>Genre</StyledContentsTitle>
            <StyledContents>
        ...
        {details.runtime !== 0 && (
          <StyledContentsContainer>
            <StyledContentsTitle>Runtime</StyledContentsTitle>
            <StyledContents>{details.runtime}mins</StyledContents>
          </StyledContentsContainer>
        )}

        {details.videos.results.length > 0 && (
          <StyledContentsContainer>
            <StyledContentsTitle>Trailer</StyledContentsTitle>
